...
namespace QCode
{
    ...
    {
#if UNITY_EDITOR
        [UnityEditor.MenuItem("QCode/Examples/24.AssetBundleExample/Build AssetBundle", false, 24)]
        ...
        [UnityEditor.MenuItem("QCode/Examples/24.AssetBundleExample/Run", false, 24)]
