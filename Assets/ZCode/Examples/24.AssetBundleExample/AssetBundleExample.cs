...
namespace ZCode
{
    ...
    {
#if UNITY_EDITOR
        [UnityEditor.MenuItem("ZCode/Examples/24.AssetBundleExample/Build AssetBundle", false, 24)]
        ...
        [UnityEditor.MenuItem("ZCode/Examples/24.AssetBundleExample/Run", false, 24)]
